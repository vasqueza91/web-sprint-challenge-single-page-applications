...
useRouteMatch attemps to math the current URL in the same way that a <Route> would. You can get access to the match data without rendering <Route>

1. How would you explain form validation to someone who has never programmed before?

It's a process where a web-form checks if the information provided by a user is correct.
